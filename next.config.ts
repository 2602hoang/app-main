...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      {
        source: `/${process.env.NEXT_NAME_APP1}/${process.env.NEXT_NAME_APP1}/:path*`,
        destination: `${process.env.NEXT_PUBLIC_APP_1}/${process.env.NEXT_NAME_APP1}/${process.env.NEXT_NAME_APP1}/:path*`,
      },
      {
